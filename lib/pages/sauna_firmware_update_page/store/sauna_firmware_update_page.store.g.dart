...
part of 'sauna_firmware_update_page.store.dart';
...
mixin _$SaunaFirmwareUpdatePageStore
    on _SaunaFirmwareUpdatePageStoreBase, Store {
  late final _$_secondsRemainingAtom = Atom(
      name: '_SaunaFirmwareUpdatePageStoreBase._secondsRemaining',
      context: context);
