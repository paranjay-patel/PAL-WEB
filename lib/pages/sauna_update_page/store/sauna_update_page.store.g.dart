...
part of 'sauna_update_page.store.dart';
...
mixin _$SaunaUpdatePageStore on _SaunaUpdatePageStoreBase, Store {
  late final _$_secondsRemainingAtom = Atom(
      name: '_SaunaUpdatePageStoreBase._secondsRemaining', context: context);
