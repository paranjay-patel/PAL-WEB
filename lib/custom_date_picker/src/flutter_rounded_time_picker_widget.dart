...
class _TimePickerHeader extends StatelessWidget {
  ...
  TextStyle _getBaseHeaderStyle(TextTheme headerTextTheme) {
    ...
    switch (orientation) {
      case Orientation.landscape:
        return headerTextTheme.displaySmall!.copyWith(fontSize: 30.0);
      case Orientation.portrait:
      default:
...
//      repaint: PaintingBinding.instance.systemFonts
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint selectorPaint = Paint()..color = ThemeColors.blue50;
    ...
    return GestureDetector(
      ...
      child: CustomPaint(
        ...
        painter: _DialPainter(
          ...
          backgroundColor: Theme.of(context).colorScheme.timePickerBackgroundColor,
...
class _TimePickerDialog extends StatefulWidget {
  ...
  final Function(TimeOfDay) onTapSetButton;
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          FlutterRoundedButtonAction(
            onTapButtonPositive: () {
              widget.onTapSetButton(_selectedTime);
            },
...
Widget showRoundedTimePicker({
  ...
  required Function(TimeOfDay) onTapSetButton,
}) {
  theme ??= ThemeData();
