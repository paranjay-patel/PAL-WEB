...
import 'package:found_space_flutter_web_application/custom_date_picker/src/material_rounded_date_picker_style.dart';
import 'package:found_space_flutter_web_application/custom_date_picker/src/material_rounded_year_picker_style.dart';
import 'package:found_space_flutter_web_application/custom_date_picker/src/widgets/flutter_rounded_date_picker_header.dart';
import 'package:found_space_flutter_web_application/custom_date_picker/src/widgets/flutter_rounded_day_picker.dart';
import 'package:found_space_flutter_web_application/custom_date_picker/src/widgets/flutter_rounded_month_picker.dart';
import 'package:found_space_flutter_web_application/custom_date_picker/src/widgets/flutter_rounded_year_picker.dart';
...
class FlutterRoundedDatePickerDialog extends StatefulWidget {
  ...
  final Function(DateTime) onTapSetButton;
...
class _FlutterRoundedDatePickerDialogState extends State<FlutterRoundedDatePickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final dialog = OrientationBuilder(builder: (BuildContext context, Orientation orientation) {
      ...
      return Container(
        height: Utils.getScreenSize(context).getHeight(min: 475, max: 525),
        width: Utils.getScreenSize(context).getWidth(min: 420, max: 500),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FlutterRoundedButtonAction(
              onTapButtonPositive: () {
                widget.onTapSetButton(_selectedDate);
              },
