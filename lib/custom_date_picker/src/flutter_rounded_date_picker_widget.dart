...
import 'package:found_space_flutter_web_application/custom_date_picker/src/dialogs/flutter_rounded_date_picker_dialog.dart';
...
Widget showRoundedDatePicker(
    ...
    required Function(DateTime) onTapSetButton,
    OnTapDay? onTapDay,
  ...
  Widget child = GestureDetector(
    ...
    child: Container(
      ...
      child: GestureDetector(
        onTap: () {
          // Handle gesture to prevent onTap outside the dialog
        },
