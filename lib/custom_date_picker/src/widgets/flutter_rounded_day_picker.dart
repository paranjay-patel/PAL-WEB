...
import 'package:found_space_flutter_web_application/custom_date_picker/src/thai_date_utils.dart';
...
//        assert(selectedDate.isAfter(firstDate) || selectedDate.isAtSameMomentAs(firstDate)),
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> labels =
        _getDayHeaders(style?.textStyleDayHeader ?? themeData.textTheme.bodySmall, localizations);
    ...
    return Padding(
      padding: style?.paddingDatePicker ?? const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
      child: Column(
        children: <Widget>[
          Container(
