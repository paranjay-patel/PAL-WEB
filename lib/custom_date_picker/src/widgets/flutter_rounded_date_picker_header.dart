...
class FlutterRoundedDatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle dayStyle =
        style?.textStyleDayButton ?? headerTextTheme.headlineMedium!.copyWith(color: dayColor, fontFamily: fontFamily);
    final TextStyle yearStyle =
        style?.textStyleYearButton ?? headerTextTheme.titleMedium!.copyWith(color: yearColor, fontFamily: fontFamily);
