...
import 'package:found_space_flutter_web_application/src/chameleon_theme/theme_collection.dart';
...
typedef ThemedWidgetBuilder = Widget Function(
    BuildContext context, ThemeData themeData, ThemeData darkThemeData, ThemeMode initialThemeMode);
...
class AdaptiveChameleonThemeWidget extends StatefulWidget {
  ...
  @override
  AdaptiveChameleonThemeWidgetState createState() => AdaptiveChameleonThemeWidgetState();
}

class AdaptiveChameleonThemeWidgetState extends State<AdaptiveChameleonThemeWidget> {
  ThemeMode? themeMode;
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          return AdaptiveChameleonTheme(
            data: this,
            child: widget.builder(context, _currentTheme, _currentDarkTheme, themeMode!),
          );
        }
        return Container(
