...
/// The default keyboard height. Can we overridden by passing
...
class VirtualKeyboard extends StatefulWidget {
  /// Keyboard Type: Should be initd in creation time.
...
class _VirtualKeyboardState extends State<VirtualKeyboard> {
  ...
  Widget build(BuildContext context) {
    ...
    switch (type) {
      ...
      case VirtualKeyboardType.MoreSymbolic:
        return _keyLayout(moreSymbolLayout);
      default:
        throw Error();
    }
  }
    ...
    if (key.keyType == VirtualKeyboardKeyType.String) {
      ...
      switch (key.action) {
        ...
        case VirtualKeyboardKeyAction.Symbols:
          ...
          break;
        case VirtualKeyboardKeyAction.MoreSymbols:
          setState(() {
            type = VirtualKeyboardType.MoreSymbolic;
          });
          break;
        default:
      }
  ...
  Widget _keyboardDefaultActionKey(VirtualKeyboardKey key) {
    ...
    switch (key.action!) {
      ...
      case VirtualKeyboardKeyAction.Alpha:
        ...
        break;
      case VirtualKeyboardKeyAction.MoreSymbols:
        actionKey = Icon(Icons.more_horiz, color: textColor);
        break;
    }
